...
if (empty($input_size)) {
   ...
   if (empty($input_price)) {
    ...
    if (empty($name_err) && empty($size_err) && empty($price_err)) {
        ...
        $sql = "UPDATE shoes SET name=?, size=?, price=? WHERE id=?";

        if ($stmt = mysqli_prepare($link, $sql)) {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_size, $param_price, $param_id);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please edit the input values and submit to update the shoes record.</p>
